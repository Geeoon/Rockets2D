...
void UIElementManager::addEmblem(sf::RenderTexture* t2, long double* xP, long double* yP, std::string titl, std::string d) {
	elements.push_back(std::make_shared<UIEmblem>(texture, t2, window, xP, yP, titl, d, font));
}